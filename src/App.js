        ...
        <div className="col-md-6">
          ...
          <div className="row section-content">
            <ul>
              ...
              <li>
                The total number of rounds in the game would be set by you.
              </li>
              <li>
                The player to win a round gets one point incremented on thier
                total score.
              </li>
              <li>
                The player having more score at the end of all the round WINS.
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="row add-inputs">
        ...
        <div className="col-md-2">
          <input
            ...
            placeholder="Set Total No. Of Rounds"
          />
        </div>
        <div className="col-md-1">
          <button
            onClick={() => {
              if (totalRounds === 0 || playerOne === "" || playerTwo === "") {
  ...
  useEffect(() => {
    ...
    if (
      ...
      if (currentRound < totalRounds[0]) {
        ...
        score1 > score2
          ? setDisplayMessage("Player 1 has Won the Game!")
          : setDisplayMessage("Player 2 has Won the Game!");
        setIsThisRoundOver(1);
      } else {
        setDisplayMessage("The Game has ended in a Draw.");
      }
  ...
  function handleClick(cellNum) {
    ...
    if (isThisRoundOver === 1) {
      currentRound === totalRounds[0]
        ...
        : setDisplayMessage("This Round Is Over.");
      return false;
    }
  ...
  return (
    <div className="App container">
      ...
      <div className="row bottom-message-section">
        <div className="col-md-3"></div>
        <div className="col-md-3 total-rounds">
          Total Round(s): {totalRounds[0]}
        </div>
        <div className="col-md-3 current-round">
          Current Round: {currentRound}
        </div>
        <div className="col-md-3"></div>
      </div>
      <div className="row reset-btn-section">
        <button
          onClick={() => {
            if (currentRound === totalRounds[0]) {
